...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/ASImageResize/ASImageResize.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/StripeDashboardUI/StripeDashboardUI.framework"
