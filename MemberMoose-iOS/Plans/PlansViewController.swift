...
class PlanDetailViewController: UIViewController {
    private var planNavigationState: PlanNavigationState = .Profile
...
extension PlanDetailViewController: PlanNavigationDelegate {
    func messageClicked() {
        planNavigationState = .Message
        planNavigation.setSelectedButton(planNavigationState)
        
        reloadInputViews()
    }
    func profileClicked() {
        planNavigationState = .Profile
        planNavigation.setSelectedButton(planNavigationState)
        
        reloadInputViews()
    }
    func chargeClicked() {
        planNavigationState = .Charge
        planNavigation.setSelectedButton(planNavigationState)
